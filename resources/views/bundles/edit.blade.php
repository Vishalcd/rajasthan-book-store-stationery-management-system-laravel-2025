<x-app-layout>
    <x-slot name='title'>{{ __('Update Bundle') }}</x-slot>
                    ...
                    <div class="max-w-full">
                        <section>
                            <div class="flex justify-between">
                                ...
                                <x-button-back route="{{ route('bundles.show', $bundle->id) }}" />
                            </div>
                            ...
                            <form method="post" action="{{ route('bundles.update', $bundle->id) }}"
                                ...
                                <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
                                    <div>
                                        ...
                                        <x-search-select name="school_id" :options="getSchoolOptions()"
                                            ...
                                            :selected="old('school_id', $bundle->school_id)" />
                                        <x-input-error class="mt-2" :messages="$errors->get('school_id')"
                                            :value="old('school_id', $bundle->school_id)" />
                                    </div>
                                    ...
                                    <div>
                                        ...
                                        <x-text-input id="class_name" name="class_name" type="text"
                                            ...
                                            :value="old('class_name', $bundle->class_name)" />
                                    ...
                                    <div>
                                        ...
                                        <x-text-input id="school_percentage" name="school_percentage" type="number"
                                            ...
                                            placeholder="e.g. 30%"
                                            :value="old('school_percentage', $bundle->school_percentage)" />
                                    ...
                                    <div>
                                        ...
                                        <x-text-input id="customer_discount" name="customer_discount" type="number"
                                            ...
                                            placeholder="e.g. 5%"
                                            :value="old('customer_discount', $bundle->customer_discount)" />
                                ...
                                <div class="flex items-center gap-4">
                                    <x-primary-button>{{ __('Update Bundle') }}</x-primary-button>
                                </div>
                            </form>
                        </section>
                    </div>
